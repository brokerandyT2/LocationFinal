...
namespace Location.Core.BDD.Tests.Drivers
{
    public class WeatherDriver
    {
        ...
        public void SetupExistingWeather(int locationId, DateTime lastUpdate, bool isConnectivityIssue = false)
        {
            ...
            if (locationModel == null)
            {
                throw new InvalidOperationException($"Location with ID {locationId} not found in context");
            }
            ...
            var privateSetterMethod = typeof(WeatherTestModel).GetMethod("SetPrivateProperty",
                System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Static);

            if (privateSetterMethod != null)
            {
                privateSetterMethod.Invoke(null, new object[] { weatherEntity, "Id", weatherModel.Id });
                privateSetterMethod.Invoke(null, new object[] { weatherEntity, "LastUpdate", lastUpdate });
            }

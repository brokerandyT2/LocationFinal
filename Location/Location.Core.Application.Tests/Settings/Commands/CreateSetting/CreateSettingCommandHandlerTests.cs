...
namespace Location.Core.Application.Tests.Settings.Commands.CreateSetting
{
    ...
    public class CreateSettingCommandHandlerTests
    {
        ...
        public void SetUp()
        {
            ...
            _handler = new CreateSettingCommandHandler(_unitOfWorkMock.Object, _mediatorMock.Object);
        }
        ...
        {
            // Act & Assert
            NUnit.Framework.Assert.Throws<ArgumentNullException>(() => new CreateSettingCommandHandler(null, _mediatorMock.Object));
        }

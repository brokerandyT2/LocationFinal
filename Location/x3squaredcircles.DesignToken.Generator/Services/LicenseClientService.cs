...
namespace x3squaredcircles.DesignToken.Generator.Services
{
    ...
    {
        Task<LicenseSession?> AcquireLicenseAsync(DesignTokenConfiguration config);
    ...
    public class LicenseClientService : ILicenseClientService
    {
        ...
        public async Task<LicenseSession?> AcquireLicenseAsync(DesignTokenConfiguration config)
        {
                    ...
                    if (response != null)
                    {
                        ...
                        if (response.Reason == "concurrent_limit_exceeded")
                        {
                            if (response.BurstEventsExhausted)
                            {
                                ...
                                throw new DesignTokenException(DesignTokenExitCode.LicenseUnavailable,

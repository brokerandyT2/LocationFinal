// Location.Photography.Infrastructure.Tests/Services/ExposureTriangleServiceTests.cs
...
namespace Location.Photography.Infrastructure.Tests.Services
{
    ...
    public class ExposureTriangleServiceTests
    {
        ...
        public void CalculateShutterSpeed_ShouldReturnCorrectValue_WhenApertureIncreases()
        {
            ...
            // Assert
            result.Should().Be("1/60"); // 1 stop slower to compensate for smaller aperture
        }

        [Test]
        public void CalculateShutterSpeed_ShouldReturnCorrectValue_WhenIsoIncreases()
        {
            // Arrange
            string baseShutterSpeed = "1/125";
            string baseAperture = "f/8";
            ...
            // Assert
            result.Should().Be("1/250"); // 1 stop faster to compensate for higher ISO
        }
        ...
        public void CalculateIso_ShouldReturnCorrectValue_WhenShutterSpeedIncreases()
        {
            ...
            // Assert
            result.Should().Be("200"); // 1 stop higher to compensate for faster shutter
        }
        ...
        public void CalculateShutterSpeed_ShouldThrowOverexposedError_WhenRequiredValueExceedsLimits()
        {
            ...
            string baseIso = "100";
            string targetAperture = "f/22";      // 1 stop darker
            string targetIso = "50";             // 1 stop darker
            int scale = 1;                       // full stops

            // Total: 2 stops darker, requiring shutter speed to be 4x slower (120")
        ...
        public void CalculateAperture_ShouldThrowUnderexposedError_WhenRequiredValueExceedsLimits()
        {
            ...
            string baseIso = "100";
            string targetShutterSpeed = "1/16000"; // 1 stop faster (doesn't exist in standard scales)
            string targetIso = "50";               // 1 stop lower sensitivity
            int scale = 1;                         // full stops

            // Total: 2 stops darker, requiring aperture to be sqrt(4)x wider (f/0.7)
        ...
        public void CalculateIso_ShouldThrowExposureParameterLimitError_WhenRequiredValueExceedsLimits()
        {
            ...
            // Total: 4 stops darker, requiring ISO to be 16x higher (409600)

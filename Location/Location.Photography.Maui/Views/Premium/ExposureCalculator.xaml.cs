...
namespace Location.Photography.Maui.Views.Premium
{
    public partial class ExposureCalculator : ContentPage
    {
        ...
        private void InitializeViewModel()
        {
            try
            {
                ...
                viewModel.FullHalfThirds = Application.Services.ExposureIncrements.Full;
                SetupEVSlider();
        ...
        private void exposuresteps_CheckedChanged(object sender, CheckedChangedEventArgs e)
        {
            ...
            try
            {
                ...
                if (radioButton == exposurefull)
                    ...
                    viewModel.FullHalfThirds = Application.Services.ExposureIncrements.Half;
                else if (radioButton == exposurethirdstop)
                    viewModel.FullHalfThirds = Application.Services.ExposureIncrements.Third;
    ...
    // They should match the ones defined in the ViewModel

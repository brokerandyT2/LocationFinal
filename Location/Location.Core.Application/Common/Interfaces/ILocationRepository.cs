...
{
    /// <summary>
    /// SQLite-optimized repository interface with raw SQL projections and performance enhancements
    /// </summary>
    public interface ILocationRepository
    {
        ...
        Task<Result<Domain.Entities.Location>> GetByTitleAsync(string title, CancellationToken cancellationToken = default);
        Task<Result<List<Domain.Entities.Location>>> GetNearbyAsync(double latitude, double longitude, double distanceKm, CancellationToken cancellationToken = default);
        Task<Result<PagedList<Domain.Entities.Location>>> GetPagedAsync(int pageNumber, int pageSize, string? searchTerm = null, bool includeDeleted = false, CancellationToken cancellationToken = default);
        ...
        /// </summary>
        Task<Result<PagedList<T>>> GetPagedProjectedAsync<T>(
            int pageNumber,
            int pageSize,
        ...
        /// </summary>
        Task<Result<IReadOnlyList<T>>> GetActiveProjectedAsync<T>(
            string selectColumns,
        ...
        /// </summary>
        Task<Result<IReadOnlyList<T>>> GetNearbyProjectedAsync<T>(
            double latitude,
            double longitude,
            double distanceKm,
            string selectColumns,
        ...
        /// </summary>
        Task<Result<T?>> GetByIdProjectedAsync<T>(
            int id,
            string selectColumns,
            CancellationToken cancellationToken = default) where T : class, new();
        ...
        /// </summary>
        Task<Result<IReadOnlyList<Domain.Entities.Location>>> GetBySpecificationAsync(
        ...
        /// </summary>
        Task<Result<PagedList<T>>> GetPagedBySpecificationAsync<T>(
            ISqliteSpecification<Domain.Entities.Location> specification,
            int pageNumber,
            int pageSize,
            string selectColumns,
        ...
        /// </summary>
        Task<Result<IReadOnlyList<Domain.Entities.Location>>> CreateBulkAsync(
        ...
        /// </summary>
        Task<Result<int>> UpdateBulkAsync(
            IEnumerable<Domain.Entities.Location> locations,
            CancellationToken cancellationToken = default);
        ...
        /// </summary>
        Task<Result<bool>> ExistsByIdAsync(int id, CancellationToken cancellationToken = default);
        ...
        /// </summary>
        Task<Result<IReadOnlyList<T>>> ExecuteQueryAsync<T>(
            string sql,
            Dictionary<string, object>? parameters = null,
            CancellationToken cancellationToken = default) where T : class, new();
        ...
        /// </summary>
        Task<Result<int>> ExecuteCommandAsync(
            string sql,
            Dictionary<string, object>? parameters = null,
            CancellationToken cancellationToken = default);
    }

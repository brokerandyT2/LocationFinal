...
namespace x3squaredcircles.SQLSync.Generator.Services
{
    ...
    {
        Task<LicenseSession?> AcquireLicenseAsync(SqlSchemaConfiguration config);
    ...
    public class LicenseClientService : ILicenseClientService
    {
        ...
        public async Task<LicenseSession?> AcquireLicenseAsync(SqlSchemaConfiguration config)
        {
                    ...
                    if (response != null)
                    {
                        ...
                        if (response.Reason == "concurrent_limit_exceeded")
                        {
                            if (response.BurstEventsExhausted)
                            {
                                ...
                                throw new SqlSchemaException(SqlSchemaExitCode.LicenseUnavailable,

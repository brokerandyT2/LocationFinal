// Location.Photography.Application/Queries/SunLocation/GetMoonDataQueryValidator.cs
...
namespace Location.Photography.Application.Queries.SunLocation
{
    public class GetMoonDataQueryValidator : AbstractValidator<GetMoonDataQuery>
    {
        ...
        {
            // Ensure date is not default and within reasonable range for moon calculations
